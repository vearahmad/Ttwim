...
if os.name=="nt":
	os.system("start https://t.me/tools_vip")
	clear="cls"
	pass
else:
	os.system("xdg-open https://t.me/tools_vip")
	clear="clear"
	pass
try:
...
if lul=="2":
	...
	print("  1- 0770\n  2- 0771 \n  3- 0772 \n  4- 0773 \n  5- 0774 \n  6- 0750 \n  7- 0751 \n  8- 0752 \n  9- 0753 \n  10- 0754 \n  11- 0780\n  12- ( 0771, 0780 , 0751 , 0780 )\n  13- ( 0770 , 0750 , 0780 )")
	maza=input("\n Sarata kay chi bet : ")
	print()
	print("wait .....")
	if maza=="1":
		for swr in range(50000):
		...
		for swr in range(50000):
			lol=random.randint(1000000, 9999999)
			with open("combooo1.txt", "a") as lp:
				lp.write(f"+964783{lol}:0783{lol}\n")
	elif maza=="6":
		for swr in range(50000):
			lol=random.randint(1000000, 9999999)
			with open("combooo1.txt", "a") as lp:
		...
		for swr in range(50000):
			lol=random.randint(1000000, 9999999)
			with open("combooo1.txt", "a") as lp:
				lp.write(f"+964781{lol}:0781{lol}\n")
	elif maza=="11":
		for swr in range(50000):
			lol=random.randint(1000000, 9999999)
			with open("combooo1.txt", "a") as lp:
		...
		for swr in range(20000):
			...
			with open('combooo1.txt', "a") as wsba:
				wsba.write(f"+964783{sff}:0783{sff}\n")
			with open('combooo1.txt', "a") as wsba:
				wsba.write(f"+964750{sfff}:0750{sfff}\n")
			with open('combooo1.txt', "a") as wsba:
